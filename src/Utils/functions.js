...
export default {
    ...
    sessionGuard() {
        ...
        if (!localStorage.getItem('mysystem@user')) {
    ...
    var sOption="toolbar=no,location=no,directories=no,menubar=no,scrollbars=yes,width=300,height=600,left=100,top=25";
       ...
       var winprint=window.open("","Print",sOption);
           ...
           winprint.document.write('body{font-size:13px; line-height:1.45; font-family:Arial; } \n');
           winprint.document.write('.break_page{page-break-after: always; } \n');
           winprint.document.write('.table{width:100%; max-width:100%; border-collapse: collapse; font-size:13px } \n');
           winprint.document.write('.table-bordered, .table-bordered > tbody > tr > td, .table-bordered > tbody > tr > th, .table-bordered > tfoot > tr > td, .table-bordered > tfoot > tr > th, .table-bordered > thead > tr > td, .table-bordered > thead > tr > th { border: 1px solid #F5F5F5;}');
           winprint.document.write('.main-item{font-weight: bold; } \n.main-sub-item{font-weight: bold;margin-left: 20px;} \n.sub-item{ margin-left: 20px !important;} .sub-sub-item{ margin-left: 40px !important;} \n.hide{display:none} \n.tx-right:{text-align: right !important;} \n.tx-left:{text-align: left !important;} \n.tx-center{text-align:center}');
           winprint.document.write('.table th, .table td {padding: 9px 15px !important;line-height: 1.462 !important;} th{text-align:left}');
